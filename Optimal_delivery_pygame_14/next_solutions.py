...
def next_solution_by_iter(number_of_iterations, length_taboo, random_object_solution, road, new_cost_matrix=None,
    ...
    #print(len(list_to_swap))


    #dodanie tablicy kary
    penalty_tab=[]
    for el in list_to_swap:
        penalty_tab.append((el,0))
    random_object_solution.penalty_table = penalty_tab
    ...
    #print_road(data[0]) print drogi startowej
    road = data[0]
    taboo = [data[3]]
    best_salary = 0
    best_road = []
